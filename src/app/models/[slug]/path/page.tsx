...
const CustomNode = ({ data }: { data: any }) => (
  <div className="relative">
    ...
    <div className={`absolute bottom-full left-1/2 -translate-x-1/2 mb-1.5 px-2.5 py-1 rounded-lg bg-bg-elevated border border-border text-xs text-fg font-medium shadow-lg shadow-black/40 whitespace-nowrap transition-opacity duration-150 pointer-events-none ${
